...
=======
    val tweetCount = tweetLength(tweetText())
    Var(MaxTweetLength - tweetCount)
>>>>>>> ed6f9b28918aef80817c06d38b5387016c6f897c
  }

  def colorForRemainingCharsCount(remainingCharsCount: Signal[Int]): Signal[String] = {
      Var {    
          remainingCharsCount() match {
              case charCount if 0 to 14 contains charCount => "orange" 
              case charCount if 15 to 140 contains charCount => "green"
              case _ => "red"
          }
      }
